...
class Patient
{
    ...
    {   
        ...
        if(head==null){System.out.println("No record!!");}
        else{
        while(temp!=null)
        {
            System.out.println("Patient Name:"+temp.patientName+"      Doctor Name:"+temp.doctorName+"     Entry time:"+temp.currentTime);
            temp=temp.next;
        }}
    }
}
...
class Doctor
{
    ...
    void show()
    {
        ...
        if(temp==null){System.out.println("No record!!");}
        else{
        while(temp!=null)
        {
            System.out.println("Name:"+temp.name+"    Field:"+temp.field+"    Number of patients:"+temp.no_of_patients+"     Availability:"+temp.availability);
            temp=temp.next;
        }}
    }
    void show(int x)
    {
        ...
        if(temp==null){System.out.println("No record!!");}
            ...
            while(temp!=null)
            {
                ...
                temp.rand=r;
                System.out.println("Name:"+temp.name+"    Field:"+temp.field+"    Number of patients:"+temp.no_of_patients+"     Availability:"+temp.availability+"    Doctor ID:"+temp.rand);
                temp=temp.next;
            }
        }
    }
